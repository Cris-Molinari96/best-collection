...
import com.example.testhibernate.entity.Review;
...
//            findTypedFromIdCourse(instructorRepo);
            createNewReview(instructorRepo);
        };
    }

    private void createNewReview(InstructorRepo instructorRepo) {
        Course course = instructorRepo.typedFindCourse(3);
        course.addReview(new Review( "Fa schifo"));
        instructorRepo.saveReview(course);
